namespace Zoo_market
{
	partial class AddSet
	{
		...
		private void InitializeComponent()
		{
			...
			this.наборыBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.наборыTableAdapter = new Zoo_market.DBDataSetTableAdapters.НаборыTableAdapter();
			...
			((System.ComponentModel.ISupportInitialize)(this.наборыBindingSource)).BeginInit();
			...
			// наборыBindingSource
			// 
			this.наборыBindingSource.DataMember = "Наборы";
			this.наборыBindingSource.DataSource = this.dBDataSet;
			// 
			// наборыTableAdapter
			// 
			this.наборыTableAdapter.ClearBeforeFill = true;
			// 
			// товарBindingSource
			// 
			...
			this.label2.Text = "ID Подвида";
			// 
			// comboBox1
			// 
			this.comboBox1.DataSource = this.товарBindingSource1;
			...
			this.comboBox1.Size = new System.Drawing.Size(245, 46);
			...
			this.товарBindingSource1.DataSource = this.dBDataSet;
			// 
			// comboBox2
			// 
			this.comboBox2.DataSource = this.подвидыBindingSource;
			this.comboBox2.DisplayMember = "Id_Подвида";
			...
			this.comboBox2.Location = new System.Drawing.Point(203, 153);
			this.comboBox2.Name = "comboBox2";
			this.comboBox2.Size = new System.Drawing.Size(245, 46);
			this.comboBox2.TabIndex = 3;
			this.comboBox2.ValueMember = "Id_Подвида";
			// 
			// label3
			// 
			...
			this.MaximumSize = new System.Drawing.Size(502, 416);
			this.MinimumSize = new System.Drawing.Size(502, 416);
			this.Name = "AddSet";
			this.Text = "AddSet";
			this.Load += new System.EventHandler(this.AddSet_Load);
			((System.ComponentModel.ISupportInitialize)(this.dBDataSet)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.наборыBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource наборыBindingSource;
		private DBDataSetTableAdapters.НаборыTableAdapter наборыTableAdapter;
